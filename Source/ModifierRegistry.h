...
public:
    static const std::array<ModifierMetadata, static_cast<size_t> (ModifierType::Unknown)>& entries()
    {
        static const std::array<ModifierMetadata, static_cast<size_t> (ModifierType::Unknown)> metadata {{
            ...
            { ModifierType::BufferVolumeRampDown,        ModifierCategory::BufferEffect,    "Volume Ramp Down",    "Volume Ramp Down",    "Channel Effect", "Fade volume to silence over 1-4 bars, hold, then ramp back up",                      true,  true,  true, false, 0.25f },
